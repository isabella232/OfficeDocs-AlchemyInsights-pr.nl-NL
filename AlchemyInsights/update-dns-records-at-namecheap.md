...
---
# <a name="update-dns-records-at-namecheap"></a>DNS-records bijwerken bij NameCheap

Gebruik de onderstaande koppelingen om uw DNS-records bij te werken

- [DNS-records maken bij NameCheap](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-namecheap?view=o365-worldwide)
