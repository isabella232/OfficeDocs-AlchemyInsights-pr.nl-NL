 ...
 **Sites verwijderen uit de nieuwe SharePoint-admin center**
...
Tips:
- Globale beheerders en beheerders van SharePoint kunt u sites die tot een **Groep met Office 365 behoren**nu verwijderen. Hiermee verwijdert u de groep en alle bronnen, met inbegrip van het Outlook-postvak en agenda en alle kanalen Teams. Zie voor meer info, [een SharePoint-site verwijderen](https://docs.microsoft.com/sharepoint/manage-sites-in-new-admin-center#delete-a-site)
...
- Als u wilt volledig verwijderen van een site met Powershell, Zie het voorbeeld van de cmdlet [Verwijderen SPSite](https://docs.microsoft.com/powershell/module/sharepoint-server/remove-spsite?view=sharepoint-ps) . 
