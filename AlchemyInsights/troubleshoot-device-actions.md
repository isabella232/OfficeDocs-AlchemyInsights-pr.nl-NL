...
---
# <a name="troubleshoot-device-actions"></a>Apparaatacties oplossen

Ga naar het [Documenten oplossen](https://docs.microsoft.com/configmgr/tenant-attach/technical-reference) voor Apparaatacties.
