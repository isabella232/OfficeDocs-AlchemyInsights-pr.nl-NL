...
---
# <a name="sharepoint-online-site-management"></a>SharePoint Online-site beheer

Hier volgen enkele veelgestelde vragen over het beheer van SharePoint Online-sites:

- [Sites beheren](https://docs.microsoft.com/sharepoint/manage-sites-in-new-admin-center)
- [Opslaglimieten voor sites beheren](https://docs.microsoft.com/sharepoint/manage-site-collection-storage-limits)
