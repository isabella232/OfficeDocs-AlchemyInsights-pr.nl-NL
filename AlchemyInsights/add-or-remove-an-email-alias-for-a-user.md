 ...
 **Opmerking:** U meer dan één e-mailadres voor een gebruiker hebben, maar aanvullende *e-mailaliassen* kunnen alleen worden gebruikt voor het ontvangen van e-mail. Als u e-mail met een alias wilt verzenden, maakt u een [gedeeld postvak](https://docs.microsoft.com/office365/admin/email/create-a-shared-mailbox). Op deze manier krijgt u de alias om e-mail te verzenden en te ontvangen.
