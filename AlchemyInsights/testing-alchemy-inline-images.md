...
---
# <a name="access-the-domains-page"></a>De pagina domeinen openen

Als u de pagina domeinen wilt openen, klikt u op dit pictogram hieronder:
...
Vervolgens kunt u uw domein toevoegen, wijzigen of verwijderen.
Zie voor meer informatie de [Veelgestelde vragen over domeinen.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)
