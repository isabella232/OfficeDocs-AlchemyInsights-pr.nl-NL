...
3. [Meer informatie over het inschrijven voor macOS apparaten in Microsoft Intune](https://docs.microsoft.com/en-us/intune/macos-enroll).
    
[Handleiding inschrijven voor macOS apparaat in Microsoft Intune eindgebruiker uitchecken](https://docs.microsoft.com/en-us/intune-user-help/enroll-your-device-in-intune-macos-cp)
