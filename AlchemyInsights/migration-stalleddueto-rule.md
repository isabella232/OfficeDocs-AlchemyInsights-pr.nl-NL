...
---
# <a name="stalleddueto-errors-during-migration"></a>VastgelopenDueTo-fouten tijdens de migratie

Mogelijk ziet u een groot aantal fouten die beginnen met 'StalledDueTo...' tijdens de migratie naar Exchange Online. Veel van deze fouten zijn heel normaal. Zie Resource [based Throttling and Prioritization in Exchange Online Migrations (Resource Based Throttling and Prioritization in Exchange Online Migrations](https://techcommunity.microsoft.com/t5/exchange-team-blog/resource-based-throttling-and-prioritization-in-exchange-online/ba-p/608020)).
