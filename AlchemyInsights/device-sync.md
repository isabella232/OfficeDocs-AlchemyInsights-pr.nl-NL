...
ms.locfileid: "54031113"
---
# <a name="device-sync"></a>Apparaatsynchronisatie

**Als apparaatsynchronisatie niet werkt, onthoud dan de volgende punten:**

- Een apparaatobject is alleen zichtbaar in de Azure-portal na het uitvoeren van apparaatregistratie.
- Als u wilt dat het apparaat wordt verbonden met on-premises domein en Azure, dat wil zeggen hybride join, volgt u de onderstaande koppelingen voor meer informatie:
