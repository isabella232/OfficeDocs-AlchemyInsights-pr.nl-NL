...
---
# <a name="create-sharepoint-sites-using-templates"></a>SharePoint-sites met behulp van sjablonen maken
...
**Knop Opslaan/sitelijst-sjabloon is niet beschikbaar of ontbreekt**

Aangepast Script dat moet beheerders waarmee de sjabloonfuncties. Zie voor gedetailleerde stappen voorbeelden en overwegingen 

- [Toestaan of voorkomen van aangepast script](https://docs.microsoft.com/sharepoint/allow-or-prevent-custom-script)
...
- De site mogelijk te veel bronnen gebruikt en daarom de sitesjabloon overschrijdt de limiet van 50 MB.
...
Raadpleeg voor meer gedetailleerde informatie over algemene problemen en oplossingen, [sitesjablonen maken en gebruiken](https://support.office.com/article/Create-and-use-site-templates-60371B0F-00E0-4C49-A844-34759EBDD989).
