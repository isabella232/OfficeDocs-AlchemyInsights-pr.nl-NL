...
SI vous recevez du courrier indésirable, vous pouvez bloquer les mailadressen de messagerie et des domaines que vous ne voulez pas recevoir des berichten. Ajouter een adresse de messagerie ou un domaine à votre lijst des expéditeurs bloqués storten déplacer ces berichten directement ver votre dossier courrier indésirable.

1. Accédez à **Paramètres** > **Opties**.
2. Dans le volet gauche, sélectionnez **courrier indésirable** > **bloqués expéditeurs**.
